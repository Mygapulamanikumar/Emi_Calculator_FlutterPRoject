...
import 'EMIColumnWidget.dart';
import 'ResultWidget.dart';

class EMIScreenWidget extends StatefulWidget {
  const EMIScreenWidget({super.key});

  @override
  EMIScreenState createState() => EMIScreenState();
}

class EMIScreenState extends State<EMIScreenWidget> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        children: [
          EMIColumnWidget(labelText: 'Loan Amount', controller: loanAmountController,min:0,max:200000, maxLength:6 ,),
          EMIColumnWidget(labelText: 'Interest Rate', controller: interestRateController,min:0,max:30, maxLength:2 ,),
          EMIColumnWidget(labelText: 'Tenure', controller: tenureController,min:0,max:30, maxLength:2, ),
